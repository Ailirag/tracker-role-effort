...
export interface RoleConfig {
    id: RoleId;
    title: string;
    /** id числового поля с оценкой в часах (например `developerEstimate`). */
    estimateField: string | null;
    /**
     * id полей типа «пользователь», по которым определяется исполнитель роли
     * (например `developerIt_one`). Ворклог относится к роли, если его автор
     * совпал с любым из этих полей задачи.
     */
